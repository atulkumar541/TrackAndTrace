...
<html>
<head>
	<title>My Track and Trace</title>
         	...
         	<div class="topbar-right-items pull-right">
              ...
              <li class="dropdown"><a class="dropdown-toggle btn btn-red-4  btn-small" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-log-in" > Login <span class="caret"></span></a>
                <ul class="dropdown-menu">
                  <li id="dropdown-itemlogin" class="" ><a href="<?php base_url();?>Companylogin/login">Company</a></li>
      	...
      	<div class="fluid">
      		<div class="navbar navbar-default">
      			<div class="navbar-header">
      				<button type="button" data-toggle="collapse" data-target="#navbar-collapse-grid" class="navbar-toggle two three"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span>
      				</button>
	              ...
	              <ul class="nav red-4 navbar-nav">
	                <li><a href="<?php base_url();?>home/index" class="dropdown-toggle active"><span class="glyphicon glyphicon-home" ></span> Home</a></li>
