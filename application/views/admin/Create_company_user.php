...
<div class="content-wrapper">
  ...
  <div class="content-header">
    ...
    <div class="card-header">
      ...
      <?php echo form_open('admindash/create_user') ?>
        <div class="card-body">
          <div class="form-group">
            <label for="exampleInputPassword1">Select Company</label>
            <select class="form-control" name="selctcompany">
              <option value="" class="form-control active">Select Your Company</option>
              <?php 
          ...
          <div class="form-group">
            ...
            <input type="text" name="user_name" value="<?php echo set_value('user_name') ?>" class="form-control" id="Companyname" placeholder="Enter User Name">
            <?php echo form_error('user_name','<div class="error" style="color:red;">','</div>') ?>
          </div>
          <div class="form-group">
            <label for="Companyemail">User Email address</label>
            <input type="text" name="user_email" value="<?php echo set_value('user_email') ?>" class="form-control" id="Companyemail" placeholder="Enter User email">
