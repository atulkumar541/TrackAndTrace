      	...
      	<div class="fluid">
      		<div class="navbar navbar-default">
	              ...
	              <ul class="nav red-4 navbar-nav">
	                <li><a href="#" class="dropdown-toggle active"><span class="glyphicon glyphicon-home" ></span> Home</a></li>
	                <li><a href="<?php base_url();?>" class="dropdown-toggle">My Track & Trace</a></li>
